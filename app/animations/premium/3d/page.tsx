...
/* src/app/animations/premium/3d/page.tsx */
"use client";

import Premium3D from "@/app/components/animations/Premium3D";
      ...
      <section className="relative pt-24 px-4 sm:px-6 md:px-8 max-w-[100vw] mx-auto border-b border-gray-700 overflow-hidden">
        <div className="relative w-full h-[80vh] max-w-7xl mx-auto">
          <div className="absolute inset-0 z-0">
            <Premium3D className="w-full h-full" />
          </div>
          <motion.div
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-xl mb-6">
              Interact with a futuristic low-poly wireframe powered by `@react-three/fiber`.
            </p>
      ...
      >
        ...
        >
          <span
            ...
            aria-label="Animation properties for premium 3D showcase"
          >
            Animation: Futuristic Wireframe Structure
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tight">
            Explore Premium 3D Animation
          </h2>
          <p className="text-base md:text-lg text-gray-400 max-w-3xl mx-auto mb-12">
            Interact with a dynamic low-poly landscape. Click to highlight
            triangles, drag to reposition sections, and zoom/pan to explore.
          </p>
        ...
        <motion.div
          ...
          style={{ y: yRange, opacity: opacityRange }}
        >
          <Premium3D className="w-full max-w-4xl" />
        </motion.div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 md:px-8 max-w-[100vw] mx-auto border-b border-gray-700">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-400 max-w-3xl mx-auto mb-8">
            Elevate your Next.js apps with `react-animations` and premium 3D effects.
            Install via `npm install react-animations` and explore our docs to
            integrate dynamic, interactive animations like this futuristic wireframe.
          </p>
          <hr className="border-gray-700 mb-6 max-w-md mx-auto" />
